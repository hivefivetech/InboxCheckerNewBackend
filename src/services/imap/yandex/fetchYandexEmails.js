...
/**
 * Mongoose Schema for Yandex emails.
 */
...
/**
 * Fetch emails from Yandex using IMAP.
 ...
 */
async function fetchYandexEmails(user, pass, folders = ["Inbox", "Spam"]) {
    ...
    client.on('error', (error) => {
        console.error(`IMAP error for Yandex account ${user}:`, error.message);
    });
...
module.exports = { fetchYandexEmails };
